      ...
      <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DropdownMenuContent className="w-fit">
          <DropdownMenuGroup className="flex flex-col gap-2">
            <DropdownMenuItem onClick={handleEdit} className="cursor-pointer justify-between">
              Edit
            ...
            {
              onDelete && (
                <DropdownMenuItem onClick={handleDelete} className="cursor-pointer justify-between">
                  Delete
