...
const requiredFields = {
  personalInformation: ['firstName', 'lastName', 'email', 'telegram'],
  professionalDetails: ['organization', 'gender', 'age', 'socialMedia'],
  participation: ['duration', 'checkIn', 'checkOut', 'successLookLike', 'topicTracks'],
  childrenPlusOnes: [],
  scholarship: []
}
